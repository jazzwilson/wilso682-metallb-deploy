pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/jazzwilson/wilso682-metallb-deploy'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('wilso682-225')   // <---- Change this to match your kubernetes cluster credentials
    }
